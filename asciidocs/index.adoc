...
----
** Umgekehrt ist das nicht möglich. Bin ich "in" einem Hobby Objekt, habe ich keinen Zugriff auf alle Personen die diese Hobby ausüben
...
NOTE: Am Anfang immer *mvnw clean* ausführen, um den target Ordner zu löschen.
