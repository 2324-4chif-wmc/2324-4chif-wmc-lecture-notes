...
image::callback-hell.png[]

* siehe auch https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise[Promises in JS^]:
...
* https://github.com/caberger/android-scratch
...
** https://developer.android.com/training/dependency-injection/hilt-android[DI mit Hilt]
...
=== Design-Prinzipien für Design von User-Interface Anwendungen
...
== 2024-01-24 - Android
_Mitschrift Leon Leeb_

=== Dependency injection:

"new" ist immer falsch, dann kriegen wir den kontext nicht mit
wir verlassen uns auf unseren DI-Container, der macht das für uns. Wir markieren die Klasse mit @ApplicationScoped (oder einem anderen Scope) und der DI-Container erstellt das Objekt wenns es das erste Mal injected wird. Falls vorhanden gibt er uns das vorhandene Objekt

==== Hilt dependency injection für android:
...
=== Prinzipien für ui design (coke and pepsi):
...
==== RxJava extension (in der module gradle):

- reactive Rxjava 3
- androidx compose runtime

==== Bei unserer Android App:
...
++++
<iframe width="560" height="315" src="https://www.youtube.com/embed/s_o8dwzRlu4?si=H6C5zQp6Mxv0bsI-" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
++++

https://quarkus-seminar.github.io/2024-lab-minikube/

++++
<iframe width="560" height="315" src="https://www.youtube.com/embed/0swOh5C3OVM?si=AqfakqAPC0CiYK9t" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
++++
...
== 2024-04-04 Reactive in Angular
...
== 2024-04-15 Bean Validation

* https://cheatsheetseries.owasp.org/cheatsheets/Bean_Validation_Cheat_Sheet.html[Bean Validation Cheat Sheet^]
* https://docs.jboss.org/hibernate/stable/validator/reference/en-US/html_single/#preface[Hibernate Validator 8.0.1.Final - Jakarta Bean Validation Reference Implementation: Reference Guide^]
* https://quarkus.io/guides/validation[Validation with Hibernate Validator^]
* https://www.baeldung.com/java-validation[Java Bean Validation Basics^]

image::bean-validation.png[]
...
* Für Bilder nicht img verwenden sondern picture!

** https://developer.mozilla.org/en-US/docs/Web/HTML/Element/picture


* JS Modules für echte Parallelität beim LAden eine HTML Seite
